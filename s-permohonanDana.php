...
$data = mysqli_query($conn, "SELECT * FROM tbl_pembuka WHERE id_pembuka='IDP004'");
$pembuka = mysqli_fetch_array($data);
//Mengambil data pada tabel penutup
$data1 = mysqli_query($conn, "SELECT * FROM tbl_penutup WHERE id_penutup='INP004'");
...
<div class="content-wrapper ">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Surat Permohonan Dana Kegiatan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Surat Permohonan Dana Kegiatan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- form start -->
            <form action="komponen/script/input_s_permohonanDana.php" enctype="multipart/form-data" method="post">
                <!-- Kop Surat-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">Masukan 1 atau 2 logo.</small>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="terbit-tanggal" name="tglTerbit" placeholder="2 maret 2021" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="perihal" id="perihal" placeholder="Contoh : Permohonan partisipasi dana " required>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control " rows="2" name="isiSurat1" id="isi_surat">Sehubungan dengan akan diselenggarakannya . . . . . . . . . . kami akan mengadakan . . . . . . . . . .  Adapun untuk merealisasikannya, kami membutuhkan dana sebesar Rp. 1,000,000,- (Satu Juta Rupiah) dengan rincian kegiatan dan anggaran terlampir
                            </textarea>
                        </div>
                        <!--Isi Surat-->
                        <div class="form-group">
                            <textarea class="form-control " rows="2" name="isiSurat2" id="isi_surat">Maka dari itu kami mengharpkan partisipasi Bapak/Ibu untuk dapat menyisihkan sedikit bantuan dana agar kegiatan tersebut dalam berjalan dengan baik sesuai harapan.
                            </textarea>
                        </div>
                    </div>
                    <!--/. card-body -->
