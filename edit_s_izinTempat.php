...
<div class="content-wrapper ">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Surat Permohonan Izin Peminjaman Tempat</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Edit Surat Permohonan Izin Peminjaman Tempat</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- form start -->
            <form action="komponen/script/edit_s_izinTempat.php?id=<?php echo $set['id_surat']; ?>" enctype="multipart/form-data" method="post">
                <!-- Kop Surat-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="terbit-tanggal" name="tglTerbit" value="<?php echo $set['tglTerbit']; ?>" placeholder="4 Juni 2021" required>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-footer">
                        <a href="dt_s_izinTempat.php" class="btn btn-secondary mr-3">Cancel</a>
