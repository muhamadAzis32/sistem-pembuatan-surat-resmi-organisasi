<?php
session_start();
$_SESSION['inputDana'] = "Surat Permohonan Dana Kegiatan";
...
$vjeniSurat ="4"; //kode surat izin tempat
...
$sql = "INSERT INTO tbl_surat (id_surat,jenisSurat,namaInstansi,jenisInstansi,alamat,telp,website,logoKop1,tempatTerbit,tglTerbit,noSurat,perihal,lampiran,penerima, isiSurat1,isiSurat2,ttdKetua,ttdSekretaris, id_user,id_pembuka,id_penutup) VALUES ('$vidSurat','$vjeniSurat','$vnamaInstansi','$vjeniInstansi','$valamat','$vtelp','$vwebsite','$lokasi','$vtmpTerbit','$vtglTerbit','$vnoSurat','$vperihal','$vlampiran','$vpenerima','$visiSurat1','$visiSurat2','$vttdKetua','$vttdSekretaris', '$vidUser','$vidPembuka','$vidPenutup') ";
