...
if (empty($namaFile)) { //Jika tidak upload  gambar
    ...
    $sql = "UPDATE tbl_surat SET namaInstansi='$vnamaInstansi',jenisInstansi='$vjeniInstansi',alamat='$valamat',telp='$vtelp',website='$vwebsite',tempatTerbit='$vtmpTerbit',tglTerbit='$vtglTerbit',noSurat='$vnoSurat',perihal='$vperihal',lampiran='$vlampiran',penerima='$vpenerima', isiSurat1='$visiSurat1',isiSurat2='$visiSurat2', hariTgl='$vhariTgl',waktu='$vwaktu',tempat='$vtempat',ttdKetua='$vttdKetua',ttdSekretaris='$vttdSekretaris' WHERE id_surat='$vidSurat' ";
    ...
    //query SQL untuk edit data
    $sql = "UPDATE tbl_surat SET namaInstansi='$vnamaInstansi',jenisInstansi='$vjeniInstansi',alamat='$valamat',telp='$vtelp',website='$vwebsite',logoKop1='$lokasi',tempatTerbit='$vtmpTerbit',tglTerbit='$vtglTerbit',noSurat='$vnoSurat',perihal='$vperihal',lampiran='$vlampiran',penerima='$vpenerima', isiSurat1='$visiSurat1',isiSurat2='$visiSurat2',hariTgl='$vhariTgl',waktu='$vwaktu',tempat='$vtempat',ttdKetua='$vttdKetua',ttdSekretaris='$vttdSekretaris' WHERE id_surat='$vidSurat' ";
    $query = mysqli_query($conn, $sql);
