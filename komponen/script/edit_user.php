...
if (empty($namaFile)) { //Jika tidak upload gambar
    ...
    $query = "UPDATE tbl_user set nama_user='$vnama', password_user='$vpassword', email_user='$vemail' WHERE id_user='$idUser' ";
    ...
    //query SQL untuk edit data
    $query = "UPDATE tbl_user set nama_user='$vnama', password_user='$vpassword', email_user='$vemail',poto_user='$lokasi' WHERE id_user='$idUser' ";
