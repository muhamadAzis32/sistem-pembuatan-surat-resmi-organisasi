...
$_SESSION['inputKegiatan'] = "Surat Izin Kegiatan Organisasi";
...
$vjeniSurat ="3"; //kode surat izin tempat
...
$sql = "INSERT INTO tbl_surat (id_surat,jenisSurat,namaInstansi,jenisInstansi,alamat,telp,website,logoKop1,tempatTerbit,tglTerbit,noSurat,perihal,lampiran,penerima, isiSurat1,isiSurat2, hariTgl,waktu,tempat,ttdKetua,ttdSekretaris, id_user,id_pembuka,id_penutup) VALUES ('$vidSurat','$vjeniSurat','$vnamaInstansi','$vjeniInstansi','$valamat','$vtelp','$vwebsite','$lokasi','$vtmpTerbit','$vtglTerbit','$vnoSurat','$vperihal','$vlampiran','$vpenerima','$visiSurat1','$visiSurat2','$vhariTgl','$vwaktu','$vtempat','$vttdKetua','$vttdSekretaris', '$vidUser','$vidPembuka','$vidPenutup') ";

$query = mysqli_query($conn, $sql);

if ($query) {
    // mengalihkan ke halaman 
    header("location:../../dt_s_izinKegiatan.php");
} else {
