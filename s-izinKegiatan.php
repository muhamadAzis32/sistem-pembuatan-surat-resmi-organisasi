...
<div class="content-wrapper ">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Surat Izin Kegiatan Organisasi</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Surat Izin Kegiatan Organisasi</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- form start -->
            <form action="komponen/script/input_s_izinKegiatan.php" enctype="multipart/form-data" method="post">
                <!-- Kop Surat-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="terbit-tanggal" name="tglTerbit" placeholder="Contoh : 4 Juli 2021" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="perihal" id="perihal" placeholder="Contoh : Izin Kegiatan Organisasi " required>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control " rows="2" name="isiSurat1" id="isi_surat">Dalam rangka memperingati dan memeriahkan ......  , kami bermaksud  mengadakan kegiatan ...... pada:
                            </textarea>
                        </div>
                        ...
                        <!--Isi Surat2-->
                        <div class="form-group">
                            <textarea class="form-control " rows="2" name="isiSurat2" id="isi_surat2">Oleh karena itu kami panitia pelaksanaan kegiatan bermaksud memohon izin untuk mengadakan acara tersebut, agar kegiatan ini dapat berjalan dengan lancar sebagaimana mestinya.
                            </textarea>
                        </div>
                    </div>
                    <!--/. card-body -->
