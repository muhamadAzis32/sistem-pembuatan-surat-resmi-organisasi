...
$data = mysqli_query($conn, "SELECT * FROM tbl_pembuka WHERE id_pembuka='IDP001'");
$pembuka = mysqli_fetch_array($data);
//Mengambil data pada tabel penutup
$data1 = mysqli_query($conn, "SELECT * FROM tbl_penutup WHERE id_penutup='INP001'");
...
<div class="content-wrapper ">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Surat undangan Acara Resmi</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Edit Surat undangan acara resmi</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- form start -->
            <form action="komponen/script/edit_s_undangan.php?id=<?php echo $set['id_surat']; ?>" enctype="multipart/form-data" method="post">
                <!-- Kop Surat-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="terbit-tanggal" name="tglTerbit" value="<?php echo $set['tglTerbit']; ?>"  placeholder="Contoh :  04 Juni 2021" required>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control " rows="2" name="isiSurat1" id="isi_surat"> <?php echo $set['isiSurat1']; ?> </textarea>
                        </div>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-footer">
                        <a href="dt_s_undangan.php" class="btn btn-secondary mr-3">Cancel</a>
                ...
                <!-- /.Buat surat -->
                <!--id surat-->
                <input type="text" name="id_surat" id="" value="<?php echo $set['id_surat']; ?>" class="form-control d-none">
