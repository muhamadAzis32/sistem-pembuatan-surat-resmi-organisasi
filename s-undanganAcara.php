...
<div class="content-wrapper ">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Surat undangan Acara Resmi</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Surat undangan acara resmi</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- form start -->
            <form action="komponen/script/input_s_undangan.php" enctype="multipart/form-data" method="post">
                <!-- Kop Surat-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="terbit-tanggal" name="tglTerbit" placeholder="Contoh : 04 Juni 2021" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="perihal" id="perihal" placeholder="Contoh : Undangan Webinar " required>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control " rows="2" name="isiSurat1" id="isi_surat">Sehubungan dengan akan diadakannya acara (......), Maka dengan ini kami mengundang Bapak/Ibu/Saudara/I untuk menghadiri acara tersebut, pada  :
                            </textarea>
                        </div>
