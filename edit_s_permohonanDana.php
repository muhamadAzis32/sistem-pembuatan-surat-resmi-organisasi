...
<div class="content-wrapper ">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Surat Permohonan Dana Kegiatan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Edit Surat Permohonan Dana Kegiatan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- form start -->
            <form action="komponen/script/edit_s_permohonanDana.php?id=<?php echo $set['id_surat']; ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="terbit-tanggal" name="tglTerbit" value="<?php echo $set['tglTerbit']; ?>" placeholder="Contoh : 4 maret 2021" required>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control " rows="3" name="isiSurat1" id="isi_surat"><?php echo $set['isiSurat1']; ?>
                            </textarea>
                        </div>

                        <!--Isi Surat2-->
                        <div class="form-group">
                            <textarea class="form-control " rows="3" name="isiSurat2" id="isi_surat"><?php echo $set['isiSurat2']; ?>
                            </textarea>
                        </div>
                    </div>
                    <!--/. card-body -->
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-footer">
                        <a href="dt_s_permohonanDana.php" class="btn btn-secondary mr-3">Cancel</a>
